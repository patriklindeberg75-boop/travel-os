...
---
**Date:** 2026-06-23
**Decision:** Bulgaria trip (bulgaria-2026-06) restructured again mid-trip (Route Revision 3) — Rila/Sapareva Banya leg dropped entirely, Plovdiv added back as a 1-night stop, Bansko extended to 3 nights with two Pirin hikes. New route: Sofia (3n) → Plovdiv (1n, Thu Jun 25) → Bansko (3n, Fri–Sun Jun 26–28) → Monday Bansko→Sofia transfer + 17:00 flight. No Sofia return night.
**Context:** Operator, now live in the trip, found the Rila accommodation (Sapareva Banya, previously the cheap Rila option) still too expensive and asked what else from the dossier could be added back instead. The Seven Rila Lakes can't be done without a trailhead overnight (pre-dawn start + full alpine hike + onward travel, all with luggage). Plovdiv had been parked in Pass 2 to make room for Bansko.
**Rationale:** (1) Plovdiv is reachable on the way without backtracking — the scenic narrow-gauge train already in the plan runs via Septemvri, which sits on the Sofia–Plovdiv mainline, so Plovdiv → Septemvri → narrow-gauge → Bansko is a clean forward leg. (2) The freed Rila night goes to Bansko, giving two full Pirin hike days (Banderishki moderate + Sinanitsa flagship) instead of one — and quieter Pirin alpine lakes are a strict upgrade over the crowded weekend Seven Rila Lakes on the anti-overtourism profile. (3) Work stays in good-WiFi cities Mon–Thu (Sofia + Plovdiv); mountains land on the work-off weekend. (4) Cheaper overall: no Rila bed, no chairlift/taxi, one fewer relay.
**Alternatives considered:** (a) Keep Rila as a return-day stop without an overnight — rejected: not feasible with luggage in one day. (b) 2nd Pirin hike only (no Plovdiv), freed night → 3rd Bansko night for Sinanitsa — viable but skips a cultural city. (c) Rila Monastery as an easy Sofia day-trip (give the night back to Sofia) — viable alternative, declined in favor of Plovdiv + a 2nd hike. (d) Black Sea beach / Koprivshtitsa — still out of scope (geography). 
**Deferred (not yet decided):** Bansko 3 nights (current) vs 2 nights + a Sofia-return Sunday night (shorter hike then same-day bus to Sofia) for a safer Monday flight buffer. Trade: relaxed mountain weekend + tight Monday travel-then-flight vs safer/calmer flight day + one long Sunday. Both keep both hikes.
